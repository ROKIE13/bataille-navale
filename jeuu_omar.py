...
def clic_placement(joueur, canvas, event):
    ...
    if taille == 5:
        messagebox.showinfo("Placement", joueur.nom+" placez votre Porte-avions")
    elif taille == 4:
        messagebox.showinfo("Placement", joueur.nom+" placez votre Croiseur")
    elif taille == 3:
        messagebox.showinfo("Placement", joueur.nom+" placez un Contre-torpilleur")
    elif taille == 2:
        messagebox.showinfo("Placement", joueur.nom+" placez votre Torpilleur")
    ...
    if not joueur.tailles_disponibles:
        if joueur == joueur1:
            messagebox.showinfo("Placement", "Au tour de "+joueur2.nom)
